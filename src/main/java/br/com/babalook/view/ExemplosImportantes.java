...
public class ExemplosImportantes extends JFrame {
	...
	private double auxContador = -50000000;

	public static void main(String[] args) {

		new ExemplosImportantes();
	...
	private class ListenForButton implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource() == button1) {
				...
				stop();
				contador = getMinutes();
				if (auxContador + contador > 0.3) {
					System.out.println("primeiro");
					ExemplosImportantes.this.dispose();
				} else {
	...
	private class ListenForKeys implements KeyListener {
		...
		public void keyTyped(KeyEvent e) {
			...
			textArea1.append("Key Hit: " + e.getKeyChar() + contador + "\n");
			start();
			auxContador = getMinutes();
		}
