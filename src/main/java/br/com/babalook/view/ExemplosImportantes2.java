...
public class ExemplosImportantes2 extends JFrame{
	...
	public static void main(String[] args){
		...
		new ExemplosImportantes2();
		
	}
	
	public ExemplosImportantes2(){
		...
		public void actionPerformed(ActionEvent e){
			...
			if(e.getSource() == button1){
				...
				try{
					...
					JOptionPane.showMessageDialog(ExemplosImportantes2.this, "Please Enter the Right Info", "Error", JOptionPane.ERROR_MESSAGE);
				...
				if(dollarSign.isSelected()) {
					...
					JOptionPane.showMessageDialog(ExemplosImportantes2.this, numFormat.format(totalCalc), "Solution", JOptionPane.INFORMATION_MESSAGE);
				...
				JOptionPane.showMessageDialog(ExemplosImportantes2.this, totalCalc, "Solution", JOptionPane.INFORMATION_MESSAGE);
